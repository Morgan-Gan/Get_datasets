...
def draw_txt(im1, start_point, font_size, save_img):
    ...
    font_number = ImageFont.truetype("/home/os/window_share/ganhaiyang/software/fonts/ArialNarrow/arialnarrow.ttf", font_size - 3)
    ...
    for i in range(len(choice_str)): 
        ...
        draw.text((start_point + i*18, 170 ), choice_str[i], (32, 24, 42), font=font)    #设置文字位置/内容/颜色/字体SZUCG
        ...
        if i == 3:
            for j in range(len(choice_num)): 
                ...
                draw.text((start_point + i*18 + j*18 + 30, 175), choice_num[j], (32, 24, 42), font=font)    #设置文字位置/内容/颜色/字体SZUCG
            # draw.text((start_point, 170 + i*87 + 230 + j*87 + 15), str_one[0], (207, 230, 236), font=font)    #设置文字位置/内容/颜色/字体SZUCG
            draw.text((start_point + i*18 + j*18 + 50 + 10, 175), str_one[0], (32, 24, 42), font=font)    #设置文字位置/内容/颜色/字体SZUCG
    ...
    cv2.rectangle(img,(start_point + i*18 + j*18 + 50 + 8, 175),(start_point + i*18 + j*18 + 50 + 20 +10, 175 + 30), (32, 24, 42), 1)
...
for i in range(12):
    ...
    image_path = "./images/background414_yangshan"
    save_path = "./images/img414_yangshan"
    ...
    for root, dirs, files in os.walk(image_path):
        for j in range(len(files)):
            ...
            start_point = random.randint(12, w//3)       # 640
            print("---------start_point : --------------->{}".format(start_point))

            # txt size
            font_size = random.randint(35, 45)     # default font size is 118
