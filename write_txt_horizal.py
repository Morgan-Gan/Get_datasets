...
def draw_txt(im1, start_point, font_size, save_img):
    ...
    font_number = ImageFont.truetype("/home/os/window_share/ganhaiyang/software/fonts/ArialNarrow/arialnarrow.ttf", font_size - 15)
    ...
    for i in range(len(choice_str)): 
        ...
        draw.text((start_point + i*85, 170 ), choice_str[i], (242, 238, 242), font=font)    #设置文字位置/内容/颜色/字体SZUCG
        ...
        if i == 3:
            for j in range(len(choice_num)): 
                ...
                draw.text((start_point + i*85 + 120 + j*88, 200), choice_num[j], (242, 238, 242), font=font)    #设置文字位置/内容/颜色/字体SZUCG
            # draw.text((start_point, 170 + i*87 + 230 + j*87 + 15), str_one[0], (207, 230, 236), font=font)    #设置文字位置/内容/颜色/字体SZUCG
            draw.text((start_point + i*85 + 230 + j*87 + 15 + 20+4, 200), str_one[0], (242, 238, 242), font=font)    #设置文字位置/内容/颜色/字体SZUCG
    ...
    # cv2.rectangle(img,(start_point+60, 1065+119+20),(start_point, 1075 + 10 + 20),(207, 230, 236),3)
    cv2.rectangle(img,(start_point + 3*85 + 230 + 5*87 + 10 + 100 + 20+8, 190),(start_point + 3*85 + 230 + 5*87 + 15 + 20, 200 + 155), (242, 238, 242), 3)
    im1 = cv2.imwrite(save_img, img)

    im1 = Image.open(save_img)
    rotated_value = random.randint(0, 2)   # 之间的任意数，必须是整数
...
for i in range(20):
    ...
    image_path = "/home/os/window_share/common3/dataset/ocr/cimc/20220419container_taicang/background/"
    save_path = "/home/os/window_share/common3/dataset/ocr/cimc/20220419container_taicang/20220419syntic_taicang"
    ...
    for root, dirs, files in os.walk(image_path):
        for j in range(len(files)):
            ...
            start_point = random.randint(12, w/2)       # 640
            print("---------start_point : --------------->{}".format(start_point))

            # txt size
            font_size = random.randint(195, 205)     # default font size is 118
            print("---------font_size : --------------->{}".format(font_size))
            save_img = save_path + "/20220420taicangBC_" + str(i*46 + j) + ".jpg"
