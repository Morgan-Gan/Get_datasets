...
chrome_driver_path = 'C:\Program Files (x86)\Google\Chrome\Application\chromedriver'
base_url = 'https://i.loli.net/2020/09/03/'
...
if __name__ == "__main__":
    ...
    for idx, seed_url in enumerate(seed_imgs_url_list):
        ...
        # 获取百度识图结果
        url_list = search_similar_images(browser, seed_url, max_page=10)  #页数可调，一页30张
