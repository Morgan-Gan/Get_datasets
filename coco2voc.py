...
dataDir = '/home/os/window_share/ganhaiyang/Alg_Proj/Detect_Proj/yolov3/data'              #'./coco'
savepath = '/home/os/window_share/ganhaiyang/Alg_Proj/Detect_Proj/yolov3/data/val/'             #'./coco/xmlcoco/val/'
...
classes_names = [ 'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 'truck', 'boat', 'trafficlight',
